...
public class EbaySearchTestBuyItNow extends BaseTest {
    ...
    @Test
    public void searchAndBuyCrush_Fragrance_Body_Lotion() {
        ...
        // Read data
        String lotionBrand = excel.getCellData(1, 1); // Row 1, Column 1

        // Step 1: Search for Samsung phone
        homePage.searchFor(lotionBrand);
        ...
        excel.setCellData(1, 2, "Crush_Fragrance_Body_Lotion Selected", excelFilePath);
